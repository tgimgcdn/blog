...
<Tabs>
  ...
  2. 进入[CloudFlare后台](https://dash.cloudflare.com/)，点击左侧的Compute(Workers),在右侧出现的界面点击Pages，然后选择Import an existing Git repository点击Get Started
  ...
  6.在Project name处填写您的项目名称，您可以随意取您喜欢的名称，在Build command处输入npm run build，在Build output directory处输入dist，点击Save and Deploy，CloudFlare即会开始自动部署项目
