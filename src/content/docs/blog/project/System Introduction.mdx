...
## PSI
<Tabs>
  <TabItem label="Mobile">![CloudFlare_8-5-2025_16387_mobile.jpeg](https://cdn.canjie.org/CloudFlare_8-5-2025_16387_mobile.jpeg)
</TabItem>
  <TabItem label="Desktop">![CloudFlare_8-5-2025_163829_desktop.jpeg](https://cdn.canjie.org/CloudFlare_8-5-2025_163829_desktop.jpeg)
</TabItem>
</Tabs>
...
<Tabs>
  ...
  4.如果您未登录GIthub，此时会出现GIthub的登录页面，您登录即可，如果您已经登录GIthub，在出现的界面下拉找到Repository access，选择Only select repositories
  Select at least one repository. Also includes public repositories (read-only).然后点击Select repositories，选择刚才您Fork的项目，点击save保存，系统会自动回到CloudFlare
